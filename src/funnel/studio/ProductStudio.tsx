...
import { attachFunnel, createProduct, ensureProducts, type StudioProduct } from "./productState";
import { FunnelStudio } from "./FunnelStudio";
import { loadFunnel, saveFunnel, seedDemo } from "./studioState";
...
export function ProductStudio() {
  ...
  const reload = () => { seedDemo(localStorage); setProducts(ensureProducts(localStorage)); };
  useEffect(() => { reload(); }, []);
